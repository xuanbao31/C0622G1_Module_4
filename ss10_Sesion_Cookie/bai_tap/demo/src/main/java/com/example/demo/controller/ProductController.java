...
public class ProductController {
    ...
    @GetMapping("/add/{id}")
    public String addToCart(@PathVariable Long id, @SessionAttribute("cart") CardDto cart) {
    ...
    public String deleteProductIn(@PathVariable Long id, @SessionAttribute("cart") CardDto cart) {
        Optional<Product> productDetail = iProductService.findById(id);
    ...
    public String delete(@PathVariable Long id, @SessionAttribute("cart") CardDto cart) {
        Optional<Product> productDetail = iProductService.findById(id);
